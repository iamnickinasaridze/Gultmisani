...
let inEnglish = [
  ...
  "Success grows in places where patience is practiced without being seen",
"Quiet effort gathers strength long before results reveal themselves",
"Ambition becomes powerful when it learns to move with restraint and clarity",
"What is built slowly often carries the greatest weight and meaning",
"Discipline turns scattered intention into something solid and dependable.",
"Progress forms beneath the surface before it becomes visible",
"Consistency gives dreams a structure they can finally stand on",
"True growth listens carefully before it decides how to move",
"Success is rarely loud; it prefers calm focus and steady direction",
"Effort leaves traces that only commitment can recognize",
"When attention is sustained, ordinary actions gain depth and purpose",
"Persistence softens resistance and reshapes what once felt immovable",
"A clear vision reduces noise and allows momentum to gather",
"What is repeated with care eventually becomes mastery",
"Success learns its rhythm through alignment of effort and discipline",
"Growth responds best to order, patience, and quiet confidence",
"Ambition matures when it values endurance over speed",
"Focus gathers scattered energy and turns it into progress",
"Purpose steadies the path when motivation fades",
"The most lasting achievements are shaped without urgency",
"Effort, when consistent, becomes its own form of guidance",
"Discipline creates calm power that does not seek attention",
"Progress deepens when attention remains undivided",
"Success forms gradually through habit rather than impulse",
"Persistence gives shape to unrealized potential",
"Vision acts as a compass, keeping movement aligned with meaning",
"Growth thrives where structure supports creativity",
"Ambition gains clarity when excess is removed",
"What is refined through repetition carries quiet authority",
"Success respects those who honor the process",
"Effort becomes powerful when guided by intention",
"Discipline allows ambition to outlast enthusiasm",
"Progress settles layer by layer, strengthening its foundation",
"Growth listens to rhythm rather than urgency",
"Success is sustained by balance, not force",
"Focus simplifies complexity and reveals direction",
"Purpose carries weight when distractions fall away",
"Persistence transforms uncertainty into confidence",
"What is built with care resists collapse",
"Success emerges when motion and meaning align",
"Effort creates momentum through steady repetition",
"Discipline keeps direction steady as conditions change",
"Growth answers patience with depth",
"Ambition finds stability when grounded in structure",
"Progress becomes inevitable when habits align with intention",
"Success favors consistency over intensity",
"Vision narrows doubt and widens possibility",
"Effort reveals character before results appear",
"Discipline preserves energy for what truly matters",
"Growth unfolds through deliberate attention",
"Persistence carries ideas beyond fragile beginnings",
"Success settles quietly into prepared space",
"Ambition matures into wisdom through restraint",
"Focus refines effort into meaning",
"Purpose strengthens resolve when the path feels long",
"Progress grows inward before showing outward",
"Success remains steady when built deliberately",
"Effort becomes legacy when sustained with care",
"Discipline shapes endurance that withstands pressure",
"Growth rewards those who listen more than rush",
"Persistence clarifies direction through repetition",
"Vision gives proportion to effort and outcome",
"Focus distills power from simplicity",
"Purpose grounds ambition in something lasting",
"Progress becomes habit when intention is honored",
"Success follows devotion more closely than talent",
"Ambition finds calm by trusting the process",
];
